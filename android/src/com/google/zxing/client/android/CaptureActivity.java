...
public final class CaptureActivity extends Activity implements
	...
	public static final String RESULT_VALUES_TAG = "ResultValues";
	...
	private void handleDecodeInternally(Result rawResult,
		 ...
		 * rawResult.getResultMetadata(); if (metadata != null) { StringBuilder
		 * metadataText = new StringBuilder(20); for
		 * (Map.Entry<ResultMetadataType,Object> entry : metadata.entrySet()) {
		 ...
		 * contentsTextView.setText(displayContents); int scaledSize =
